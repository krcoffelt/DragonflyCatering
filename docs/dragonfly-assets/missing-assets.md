...
These are the main gaps to close before a full production website build.

- Current interior and exterior photos of Dragonfly Catering & Event Space at 4325 W. Lincoln Highway.
- Bartending setup, bar service, glassware, mixers, or bartender action photos.
- Wedding and shower photos with explicit client/public-use approval.
...
- Bulk shortlist or direct download access for the Gmail `pictures` Drive links.
- Client approval decision on the recognizable-guest image saved in `photos/misc-review/original-dsc07875-family-photos.jpg`.
